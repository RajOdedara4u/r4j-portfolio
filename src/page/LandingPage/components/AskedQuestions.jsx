...
const AskedQuestions = () => {
  ...
  return (
    <section className={"relative  max-w-[90%] mx-auto py-5 md:py-10 px-4 sm:px-6 lg:px-8"}>
            ...
            >
              <summary  className={"flex items-center justify-between gap-4 cursor-pointer list-none px-4 sm:px-5 py-4 sm:py-4.5 "}>
                <div className={"flex items-center gap-3"}>
                  ...
                  <h3 className={"text-[0.7rem] md:text-[0.86rem] font-semibold text-[#020617]"}>
                    {item.question}
                  </h3>
                </div>
              ...
              <div className={"px-4 sm:px-5 border-t border-[#e5e7eb] bg-[#f9fafb]/80 overflow-hidden"}>
                <div className={"text-[0.6rem] md:text-[0.76rem] text-[#4b5563] leading-relaxed transform transition-[max-height,opacity,transform,padding] duration-400 ease-[cubic-bezier(0.22,0.61,0.36,1)] max-h-0 opacity-0 translate-y-1 py-0 group-open:max-h-96 group-open:opacity-100 group-open:translate-y-0 group-open:py-3"}>
                  {item.answer}
                </div>
              </div>
            </details>
